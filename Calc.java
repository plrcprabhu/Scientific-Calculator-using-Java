...
class Calc implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) {
		 ...
		 if(e.getSource()==brad)
		 {
		 	tf.setText(tf.getText()+" rad");
		 	c=19;
		 	fl=1;
		 }
		 if(e.getSource()==bdeg)
		 {
		 	tf.setText(tf.getText()+" deg");
		 	c=20;
		 	fl=1;
		 }
		 if(e.getSource()==bsin)
		 ...
		 if(e.getSource()==barcsin)
		 {
		 	tf.setText("asin");
		 	c=24;
		 	fl=1;
		 }
		 if(e.getSource()==barccos)
		 {
		 	tf.setText("acos");
		 	c=25;
		 	fl=1;
		 }
		 if(e.getSource()==barctan)
		 {
		 	tf.setText("atan");
		 	c=26;
		 	fl=1;
	 	...
	 	if(e.getSource()==bdot)
		{
		 ...
		 if(e.getSource()==beq)
		 {
		     ...
		     if(c==15)
		     {
		    		int len=s2.length();
		    		if(fl==1)
		    			tf.setText("INVALID OPEARATION");
		    		else 
		    		{
		    			int n=Integer.parseInt(s2.substring(0,len-1));
		    			int res=1;
		    			for(int i=1;i<=n;i++) {
		    				res*=i;
		    			}
		   ...
		   {
		    	int len=s2.length();		   	
		   	double d = Math.log10(Double.parseDouble(s2.substring(3,len)));
		   	tf.setText(Double.toString(d));
		   }
		   if(c==18)
		   {
		    	int len=s2.length();		   	
		   	double d = Math.log(Double.parseDouble(s2.substring(2,len)));
		   	tf.setText(Double.toString(d));
		   }
		   if(c==19)
		   {
		    	int len=s2.length();	
		    	double d = Math.toDegrees(Double.parseDouble(s2.substring(0,len-4)));
		    	tf.setText(Double.toString(d)+" deg");
		   }
		   if(c==20)
		   {
		    	int len=s2.length();	
		    	double d = Math.toRadians(Double.parseDouble(s2.substring(0,len-4)));
		    	tf.setText(Double.toString(d)+" rad");
		   }
		   if(c==21)
		   {
		    	int len=s2.length();
		    	double d = Math.sin(Math.toRadians(Double.parseDouble(s2.substring(3,len))));
		    	tf.setText(Double.toString(d));
		   }	
		   if(c==22)
		   {
		    	int len=s2.length();
		    	double d = Math.cos(Math.toRadians(Double.parseDouble(s2.substring(3,len))));
		    	tf.setText(Double.toString(d));
		   }		 
		   if(c==23)
		   {
		    	int len=s2.length();
		    	double d = Math.tan(Math.toRadians(Double.parseDouble(s2.substring(3,len))));
		    	tf.setText(Double.toString(d));
		   }		 
		   if(c==24)
		   {
		    	int len=s2.length();
		    	double d = Math.asin(Double.parseDouble(s2.substring(4,len)));
		    	tf.setText(Double.toString(d));
		   }		 
		   if(c==25)
		   {
		    	int len=s2.length();
		    	double d = Math.acos(Double.parseDouble(s2.substring(4,len)));
		    	tf.setText(Double.toString(d));
		   }		 
		   if(c==26)
		   {
		    	int len=s2.length();
		    	double d = Math.atan(Double.parseDouble(s2.substring(4,len)));
		    	tf.setText(Double.toString(d));
		   }		 
		  if(c==27)
		  {
		  	int len=s2.length();
		  	int n=Integer.parseInt(s2.substring(4,len));
		  	if(fl==1)
		  		tf.setText("INVALID OPERAION");
		  	else
		  	{
		  		tf.setText("bin:"+Integer.toBinaryString(n)+",oct:"+Integer.toOctalString(n)+",hex:"+Integer.toHexString(n));
		  	}
		  }
		  if(c==28)
		  {
		  	int len=s2.length();
		  	String bin=s2.substring(4,len);
		  	int n=Integer.parseInt(bin,2);
		  	if(fl==1)
		  		tf.setText("INVALID OPERAION");
		  	else
		  	{
		  		tf.setText("dec:"+Integer.toString(n)+",oct:"+Integer.toOctalString(n)+",hex:"+Integer.toHexString(n));
		  	}
		  }
		  if(c==29)
		  {
		  	int len=s2.length();
		  	String bin=s2.substring(4,len);
		  	int n=Integer.parseInt(bin,8);
		  	if(fl==1)
		  		tf.setText("INVALID OPERAION");
		  	else
		  	{
		  		tf.setText("dec:"+Integer.toString(n)+",bin:"+Integer.toBinaryString(n)+",hex:"+Integer.toHexString(n));
		  	}
		  }
		  if(c==30)
		  {
		  	int len=s2.length();
		  	String bin=s2.substring(4,len);
		  	int n=Integer.parseInt(bin,16);
		  	if(fl==1)
		  		tf.setText("INVALID OPERAION");
		  	else
		  	{
		  		tf.setText("dec:"+Integer.toString(n)+",bin:"+Integer.toBinaryString(n)+",oct:"+Integer.toOctalString(n));
		  	}
		  }
		 }
		 if(e.getSource()==bclr)
